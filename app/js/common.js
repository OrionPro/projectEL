...
$(document).ready(function() {
    ...
    tl7.from("#g5164_item1", 1.3, { rotation: 360, transformOrigin: "50% 50%", opacity: 0, x: -100, y: -100, ease: Power2.easeInOut}, 0);
    tl7.from("#g5164_item2", 1.3, { rotation: 360, transformOrigin: "50% 50%", opacity: 0, x: -100, y: -100, ease: Power2.easeInOut}, 0.3);
    tl7.from("#g5164_item3", 1.3, { rotation: 360, transformOrigin: "50% 50%", opacity: 0, x: -100, y: -100,  ease: Power2.easeInOut}, 0.6);

...
$(document).ready(function() {
    ...
    //  тени иконок
    tl8.from("#path5488", 1, { autoAlpha: 0, x: -20, ease: Power2.easeInOut}, 0.8); //
    tl8.from("#path5421", 1, { autoAlpha: 0, x: -20, ease: Power2.easeInOut}, 1.2);
    tl8.from("#path5295", 1, { autoAlpha: 0, x: -20, ease: Power2.easeInOut}, 1.7);
    tl8.from("#path5371", 1, { autoAlpha: 0, x: -20, ease: Power2.easeInOut}, 2);
    tl8.from("#path5443", 1, { autoAlpha: 0, x: -20, ease: Power2.easeInOut}, 2);
    // текст
